...
$('#post-form').submit(function (e) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      width = 101;
      for (let i = 1; i <= 2; i++) {
        var innerText = document.querySelector("#Table".concat(i).concat("> table > tbody > tr:nth-child(8) > td:nth-child(1)")).innerHTML;
        document.querySelector("#Table".concat(i).concat("> table > tbody > tr:nth-child(8) > td:nth-child(1)")).innerHTML = "<div class='tooltip'>".concat(innerText).concat("<span class='tooltiptext'>Most Money Made In A Single Year.</span></div>");
      }
